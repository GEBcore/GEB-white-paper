...
- **[GEB: A Complex Adaptive System for Perceiving Reality](./GEB：A%20Complex%20Adaptive%20System%20for%20Perceiving%20Reality.md)** (English)
- **[GEB：一个感知现实的复杂自适应系统](./GEB：一个感知现实的复杂自适应系统.md)** (中文)

> **Note**: If links don't work in your Markdown viewer, you may need to open the files directly from the file explorer.
